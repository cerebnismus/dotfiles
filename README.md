...
awesome-config was originally intended to be run on a fresh install of Arch Linux, and
provides you with a fully configured diving-board for work or more
customization. But also works on already configured systems *and* other
...
Here are some of the things awesome-config sets up:
...
By default, awesome-config uses the programs [here in progs.csv](progs.csv) and installs
[my dotfiles repo (voidrice) here](https://github.com/oguzhanlarca/voidrice),
...
awesome-config will parse the given programs list and install all given programs. Note
...
phrase) that describes the program. During installation, awesome-config will print out
this information in a grammatical sentence. It also doubles as documentation
for people who read the csv or who want to install my dotfiles manually.

Depending on your own build, you may want to tactically order the programs in
your programs file. awesome-config will install from the top to the bottom.
...
awesome-config does to bypass this by default is to temporarily allow the newly created
