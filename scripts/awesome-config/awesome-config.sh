#!/bin/sh
# Oguz's Awesome-Config Scripts
# by Oguzhanlarca <dv.oguz@gmail.com>
# License: GNU GPLv3
...
# DEFAULTS:
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/oguzhanlarca/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/oguzhanlarca/LARBS/master/progs.csv"
...
welcomemsg() { \
	dialog --title "Welcome!" --msgbox "Welcome to Kuragxon's Awesome-Config Script!\\n\\nThis script will automatically install a fully-featured i3wm Arch Linux desktop, which I use as my main machine.\\n\\n-Oguz" 10 60
	}
...
putgitrepo "https://github.com/oguzhanlarca/mozillarbs.git" "/home/$name/.mozilla/firefox"
